...
@scope/dsh-session-pin
@scope/dsh-notification
@scope/dsh-ui-tweaks
```
...
```text
@scope/dsh-draft-sessions@1.4.2
@scope/dsh-ui-tweaks@0.7.1
@scope/dsh-notification@2.1.0
```
...
npm:
dsh plugin add @scope/dsh-plugin-name
