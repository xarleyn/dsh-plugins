...
export const METRIC_NAMES = Object.freeze({
  ...
  estimatedTokensRemovedTotal:
    "dsh_prompt_firewall_estimated_tokens_removed_total",
} as const);

export type PromptFirewallMetricName =
  (typeof METRIC_NAMES)[keyof typeof METRIC_NAMES];
...
export class FirewallMetrics {
  ...
  namedSnapshot(): Readonly<Record<PromptFirewallMetricName, number>> {
    return Object.freeze({
      ...
      [METRIC_NAMES.estimatedTokensRemovedTotal]:
        this.counters.estimatedTokensRemovedTotal,
    });
  }
}
