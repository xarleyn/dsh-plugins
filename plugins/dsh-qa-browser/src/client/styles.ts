...
.dsh-qa-browser-panel__tab{max-width:180px;min-width:90px;color:var(--dsw-alias-label-tertiary);border:1px solid transparent;border-radius:8px 8px 0 0;align-items:center;gap:6px;padding:6px 10px;font-size:12px;display:flex}
...
.dsh-qa-browser-panel__refresh{width:32px;height:32px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-3);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;cursor:pointer;font-size:18px}
.dsh-qa-browser-panel__refresh:hover{color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}
.dsh-qa-browser-panel__refresh:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:2px}
.dsh-qa-browser-panel__refresh:disabled{cursor:wait;opacity:.55}
