...
const MINIMAL_ARGS: Readonly<Record<string, Record<string, unknown>>> = {
  ...
  jira_get_issue: { issueKey: "MDC-123" },
  jira_get_issue_comments: { issueKey: "MDC-123" },
  jira_get_issue_attachments: { issueKey: "MDC-123" },
  jira_get_available_transitions: { issueKey: "MDC-123" },
  jira_get_project: { projectKey: "MDC" },
  jira_get_fields: {},
};
