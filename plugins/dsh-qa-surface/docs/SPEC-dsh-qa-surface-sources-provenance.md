...
{
  kind: 'jira',
  title: 'PROJ-123 — Демо-продукт. Добавить метод GET /history',
  uri: '<actual issue URL>',
  locations: [{ jiraKey: 'PROJ-123' }],
  evidence: 'queried'
}
```
...
Documentation
• serviceDiagnosis.md · 197–218
• products_platform.md

Jira
• PROJ-123 — Демо-продукт. GET /history
...
```
...
```text
Library / docs / User_Guide / Product / ... / serviceDiagnosis.md
...
```text
serviceDiagnosis.md · lines 197–218
```
...
```text
parent
├─ read docs/User_Guide/Product/.../serviceDiagnosis.md:197-218
...
Opening `serviceDiagnosis.md` shows:
