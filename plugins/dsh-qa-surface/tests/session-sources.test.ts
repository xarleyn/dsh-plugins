...
describe("host source bridge", () => {
  ...
  it("keeps a turn the transcript filled when the Host collected nothing for it", async () => {
    ...
    const projected: QaTurnSources = {
      ...
      sources: [
        {
          id: "web:https://jira.example.corp/wiki/pages/viewpage.action?pageId=123456",
          kind: "web",
          title: "Docker - настройки",
          uri: "https://jira.example.corp/wiki/pages/viewpage.action?pageId=123456",
          locations: [],
          evidence: "queried",
          origins: [],
          score: 55,
  ...
  it("lets a Host bundle that carries sources replace the projection's turn", async () => {
    const hostBundle: QaTurnSources = {
      ...
      sources: [
        {
          id: "web:https://jira.example.corp/wiki/host",
          kind: "web",
          title: "Host collected page",
          uri: "https://jira.example.corp/wiki/host",
          locations: [],
          evidence: "fetched",
          origins: [],
          score: 100,
