    ...
    function apply(ctx) {
          ...
          ? rem
              ...
              .then(function (dispose) {
                ...
                if (typeof ctx.inject !== "function")
                  throw new Error(
                    "session-scope: client injection unavailable",
                  );
                return ctx.inject(
                  ["remote.sessionScope"],
                  function (remoteCtx) {
      ...
      function ScopeEditor(props) {
        ...
        function save(mode, draft) {
          var effectiveMode =
            snap.root !== null && draft.indexOf(snap.root) !== -1
              ? "full"
              : mode;
          var effectiveRoots =
      ...
      function ScopeButton(props) {
        ...
        var blank =
          ...
          props.session.composerPhase === "blank";
